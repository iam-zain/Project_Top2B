...
for (i in 1:100) {
  SelectCpGs <- SelectCpGsRaw[sample(nrow(SelectCpGsRaw), nrow(SelectCpGsRaw) * 0.25), ]
  SelectCpGs1 <- SelectCpGs %>% select(-OriginalAge) # Remove Age before prediction
  ...
  SelectCpGs1$OriginalAge <- SelectCpGs$OriginalAge # Add Original Age again
...
write.csv(results_df, 'Predct_CorrelationETC_Frontal.csv', row.names = F)
write.csv(Age_Compare, 'Age_Compare_Frontal.csv', row.names = F)
...
write.csv(results_df, 'Predct_CorrelationETC_Cerebellum.csv', row.names = F)
write.csv(Age_Compare, 'Age_Compare_Cerebellum.csv', row.names = F)
...
write.csv(results_df, 'Predct_CorrelationETC_Temporal.csv', row.names = F)
write.csv(Age_Compare, 'Age_Compare_Temporal.csv', row.names = F)
...
write.csv(results_df, 'Predct_CorrelationETC_All.csv', row.names = F)
write.csv(Age_Compare, 'Age_Compare_All.csv', row.names = F)
...
write.csv(results_df, 'Predct_CorrelationETC_SchizAll.csv', row.names = F)
write.csv(Age_Compare, 'Age_Compare_SchizAll.csv', row.names = F)
...
write.csv(results_df, 'Predct_CorrelationETC_AD_All.csv', row.names = F)
write.csv(Age_Compare, 'Age_Compare_AD_All.csv', row.names = F)
