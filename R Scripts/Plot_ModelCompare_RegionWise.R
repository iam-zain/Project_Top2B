setwd ("Z:\\Project_Top2B\\April_2023\\regionwise")

############   Correlation   ############ 
df = read.csv("Compare_RegionWise_DifferentModelOrData_Correlation_Long.csv",header = T)
...
ggplot(df_long, aes(x= Region, y=value, color = Type))+
  ...
  ggtitle ("Correlation: Model Compare: Region wise")


############   RMSE   ############ 
df = read.csv("Compare_RegionWise_DifferentModelOrData_RMSE_Long.csv",header = T)
#Non_Mot_Long = gather(Non_Mot, key = 'Feature', value = 'RMSE')
...
ggplot(df_long, aes(x= Region, y=value, color = Type))+
  ...
  theme(axis.title = element_text(face="bold")) + 
  xlab("\nRegion") + ylab("RMSE\n") +
  ggtitle ("RMSE: Model Compare: Region wise")


############   R-Square   ############ 
df = read.csv("Compare_RegionWise_DifferentModelOrData_RSquare_Long.csv",header = T)
#Non_Mot_Long = gather(Non_Mot, key = 'Feature', value = 'RMSE')
...
ggplot(df_long, aes(x= Region, y=value, color = Type))+
  ...
  theme(axis.title = element_text(face="bold")) + 
  xlab("\nRegion") + ylab("RSquare\n") +
  ggtitle ("R-Square: Model Compare: Region wise")



############   MAE   ############ 
df = read.csv("Compare_RegionWise_DifferentModelOrData_MAE_Long.csv",header = T)
#Non_Mot_Long = gather(Non_Mot, key = 'Feature', value = 'RMSE')
...
ggplot(df_long, aes(x= Region, y=value, color = Type))+
  ...
  theme(axis.title = element_text(face="bold")) + 
  xlab("\nRegion") + ylab("MAE\n") +
  ggtitle ("MAE: Model Compare: Region wise")




############   MSE   ############ 
df = read.csv("Compare_RegionWise_DifferentModelOrData_MSE_Long.csv",header = T)
#Non_Mot_Long = gather(Non_Mot, key = 'Feature', value = 'RMSE')
...
ggplot(df_long, aes(x= Region, y=value, color = Type))+
  ...
  theme(axis.title = element_text(face="bold")) + 
  xlab("\nRegion") + ylab("MSE\n") +
  ggtitle ("MSE: Model Compare: Region wise")
