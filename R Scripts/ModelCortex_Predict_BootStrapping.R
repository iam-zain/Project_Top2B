setwd ("Z:\\Project_Top2B\\April_2023\\Cortex_Clock\\Diseased")
df <- read.csv("Merged_Cortex_Diseased_Mean.csv", header = T)
...
cor(output$Age, output$PredAge, method = "pearson") # 0.9835151

#write.csv(output, "BorutaPy_Age_enet_10FCV.csv", row.names = F)

###### Saving the model
saveRDS(Top2_Model, file = "Model_Cortex_enet.RData")
# Loading the model
TheModel <- readRDS("Model_Cortex_enet.RData") 
...
CpgNames = colnames(df[,2:348]) # Selecting Column names from our model
...
write.csv(results_df, 'BS_Predct_CorrelationETC_Healthy_Cortex.csv', row.names = F)
write.csv(Age_Compare, 'BS_Age_Compare_Healthy_Cortex.csv', row.names = F)
...
NewData <- vroom("GSE74193_Schiz_Cortex_Age.csv")
...
write.csv(results_df, 'BS_Predict_CorrelationETC_ModelCortex_Schizophrenia.csv', row.names = F)
write.csv(Age_Compare, 'BS_Age_Compare_ModelCortex_Schizophrenia.csv', row.names = F)
...
### Diseased - AD ###
NewData <- vroom("AD_Cortex_Age.csv")
...
write.csv(results_df, 'BS_Predict_CorrelationETC_ModelCortex_AD.csv', row.names = F)
write.csv(Age_Compare, 'BS_Age_Compare_ModelCortex_AD.csv', row.names = F)
...
### Diseased - All ###
NewData <- vroom("Merged_Cortex_Diseased_Mean.csv")
...
write.csv(results_df, 'BS_Predict_CorrelationETC_ModelCortex_DiseasedAll.csv', row.names = F)
write.csv(Age_Compare, 'BS_Age_Compare_ModelCortex_DiseasedAll.csv', row.names = F)
...
write.csv(results_df, 'BS_Predict_CorrelationETC_OurModel_DataSetCortex_Schizophrenia.csv', row.names = F)
write.csv(Age_Compare, 'BS_Age_Compare_OurModel_DataSetCortex_Schizophrenia.csv', row.names = F)
...
write.csv(results_df, 'BS_Predict_CorrelationETC_OurModel_DataSetCortex_AD.csv', row.names = F)
write.csv(Age_Compare, 'BS_Age_Compare_OurModel_DataSetCortex_AD.csv', row.names = F)
...
### Diseased - All ###
setwd ("Z:\\Project_Top2B\\April_2023\\Cortex_Clock\\Our_Model")
NewData <- vroom("Merged_236_Diseased_Cortex_Mean.csv")
...
write.csv(results_df, 'BS_Predict_CorrelationETC_OurModel_DataSetCortex_All.csv', row.names = F)
write.csv(Age_Compare, 'BS_Age_Compare_OurModel_DataSetCortex_All.csv', row.names = F)
...
### Healthy - All ###
NewData <- vroom("Merged_236_Healthy_Cortex_Mean.csv")
...
write.csv(results_df, 'BS_Predict_CorrelationETC_OurModel_DataSetCortex_Healthy.csv', row.names = F)
write.csv(Age_Compare, 'BS_Age_Compare_OurModel_DataSetCortex_Healthy.csv', row.names = F)
