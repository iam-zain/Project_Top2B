...
ggplot(Non_Mot_Long, aes(x = factor(Feature,level=c('All_Merged','Frontal','Cerebellum','Temporal','AD','Schizophrenia')),
                         y = RMSE, fill = Feature)) + 
  ...
  ggtitle ("RMSE Random Sampling: Differents models: Prediction on Diseased Data")
...
ggplot(Non_Mot_Long, aes(x = factor(Feature, level = c('All_Merged','Frontal','Cerebellum','Temporal','AD','Schizophrenia')),
  ...
  theme(axis.text = element_text(face="bold")) + theme(text = element_text(size=18)) + 
  theme(axis.text=element_text(color="black")) + theme(plot.title = element_text(face="bold", size=18)) +
  ggtitle("R Square Random Sampling: Different models: Prediction on Diseased Data")
...
ggplot(Non_Mot_Long, aes(x = factor(Feature, level = c('All_Merged','Frontal','Cerebellum','Temporal','AD','Schizophrenia')),
  ...
  theme(axis.text = element_text(face="bold")) + theme(text = element_text(size=18)) + 
  theme(axis.text=element_text(color="black")) + theme(plot.title = element_text(face="bold", size=18)) +
  ggtitle("Pearson Correlation Random Sampling: Different models: Prediction on Diseased Data")
...
ggplot(Non_Mot_Long, aes(x = factor(Feature, level = c('All_Merged','Frontal','Cerebellum','Temporal','AD','Schizophrenia')),
  ...
  theme(axis.text = element_text(face="bold")) + theme(text = element_text(size=18)) + 
  theme(axis.text=element_text(color="black")) + theme(plot.title = element_text(face="bold", size=18)) +
  ggtitle("MAE Random Sampling: Different models: Prediction on Diseased Data")
...
ggplot(Non_Mot_Long, aes(x = factor(Feature, level = c('All_Merged','Frontal','Cerebellum','Temporal','AD','Schizophrenia')),
  ...
  theme(axis.text = element_text(face="bold")) + theme(text = element_text(size=18)) + 
  theme(axis.text=element_text(color="black")) + theme(plot.title = element_text(face="bold", size=18)) +
  ggtitle("MSE Random Sampling: Different models: Prediction on Diseased Data")
