...
ggplot(Non_Mot_Long, aes(x = factor(Feature,level=c('All_Merged','Frontal','Cerebellum','Temporal')),
                         y = RMSE, fill = Feature)) + 
  ...
  ggtitle ("RMSE Random Sampling: Different models: Prediction on Diseased Data")
